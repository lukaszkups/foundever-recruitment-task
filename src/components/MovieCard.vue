...
import { useMovieFavorites } from "@/stores/movies/actions/favorites";

const movies = useMoviesStore();
const movieFavs = useMovieFavorites();
...
const toggleFavorite = () => {
  if (isFavorite.value) movieFavs.removeFavorite(props.data);
  else movieFavs.addFavorite(props.data);
};
